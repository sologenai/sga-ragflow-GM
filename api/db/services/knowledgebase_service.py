...
class KnowledgebaseService(CommonService):
    ...
    def accessible4deletion(cls, kb_id, user_id):
        ...
        by checking if they are the creator of that dataset, or if they are a superuser.
        ...
        Note:
            ...
            - A return value of False can mean either:
                ...
                2. The user is not the creator of the dataset and not a superuser
        """
        # Check if user is superuser - superusers can delete any dataset
