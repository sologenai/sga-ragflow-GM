...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      docProgressSummary:
        'Task progress: completed {{completed}}/{{total}} · merged {{merged}} · failed {{failed}} · skipped {{skipped}}',
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      **Essential Rules:**
      ...
      permissions: 'Permissions',
      permissionsTip:
        'Control who can access this chat assistant. "Me" means only you can use it. "Team" means all team members can access it.',
      me: 'Me',
      team: 'Team',
    },
    setting: {
...
[Insert text here]`,
    ...
    admin: {
      ...
      sandbox: {
        ...
        providerConfigurationDescription:
          'Configure the connection settings for {{provider}}.',
        saving: 'Saving...',
        ...
        testingConnection: 'Testing connection to sandbox provider...',
        connected: 'Successfully connected to sandbox provider.',
        connectFailed: 'Failed to connect to sandbox provider.',
        exitCode: 'Exit code',
        executionTime: 'Execution time',
        standardOutput: 'Standard output',
        errorOutput: 'Error output / stack trace',
        close: 'Close',
        configUpdated: 'Sandbox configuration updated successfully',
        configUpdateFailed: 'Failed to update configuration: {{message}}',
      },
      ...
      auditSessionKicked: 'Session Kicked',
      ...
      auditKbCreated: 'KB Created',
      auditKbDeleted: 'KB Deleted',
      auditDocUploaded: 'Document Uploaded',
      auditDocDeleted: 'Document Deleted',
    ...
    knowledgeGraph: {
      ...
      searchPlaceholder: 'Search nodes by name or description...',
      entityTypes: 'Entity Types',
      ...
      noAssociatedFiles: 'No associated files found',
      andMore: 'and {{count}} more...',
      searchFailed: 'Search failed',
      getFilesFailed: 'Failed to get associated files',
      ...
      searchInFiles: 'Search in files and chunks...',
      ...
      includeFileInfo: 'Include file information',
      includeTextChunks: 'Include text chunks',
      downloadSingle: 'Download',
      downloadAll: 'Download All Formats',
      downloadTasks: 'Download Tasks',
      clearCompleted: 'Clear Completed',
      batchDownloadComplete: 'Batch download completed',
