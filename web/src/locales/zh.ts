...
例如：一条带有 1024 维嵌入的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeDetails: {
      ...
      uploadDescription:
        '支持单次或批量上传。本地部署的单次上传文件总大小上限为 1GB，严禁上传违禁文件。',
      chunk: '解析块',
      bulk: '批量',
      cancel: '取消',
      close: '关闭',
...
[在此处插入文本]`,
    ...
    knowledgeGraph: {
      ...
      files: '文件',
      textChunks: '文本片段',
      noAssociatedFiles: '未找到关联文件',
      andMore: '还有 {{count}} 个...',
      searchFailed: '搜索失败',
      getFilesFailed: '获取关联文件失败',
      ...
      entityType: '实体类型',
      communities: '社区',
      searchInFiles: '在文件和片段中搜索...',
      noFilesFound: '未找到文件',
      noChunksFound: '未找到文本片段',
      totalFiles: '文件总数',
      totalChunks: '片段总数',
      ...
      includeFileInfo: '包含文件信息',
      includeTextChunks: '包含文本片段',
      downloadSingle: '下载',
      downloadAll: '下载所有格式',
      downloadTasks: '下载任务',
      ...
      nodeKeywords: '关键词',
      nodeSourceFiles: '来源文件',
      nodeConnections: '连接关系',
      nodeImportance: '重要性',
      // 交互提示
      clickToSelect: '点击选择节点',
      dragToMove: '拖拽移动节点',
      scrollToZoom: '滚轮缩放',
      doubleClickToFocus: '双击聚焦节点',
      // 搜索相关
      searchByName: '按名称搜索',
      searchByType: '按类型搜索',
      ...
      advancedSearch: '高级搜索',
      quickSearch: '快速搜索',
      searchHint: '输入关键词搜索节点',
      searchShortcut: 'Ctrl+K 快速搜索',
      legend: '图例',
      statistics: '统计信息',
      nodes: '节点',
      edges: '连线',
    ...
    admin: {
      ...
      auditLoginSuccess: '登录成功',
      auditLoginFailed: '登录失败',
      auditLogout: '登出',
      auditAccountLocked: '账户锁定',
      auditSessionKicked: '会话被踢',
      auditUserCreated: '创建用户',
      auditUserDeleted: '删除用户',
      auditPasswordChanged: '修改密码',
      auditPasswordReset: '重置密码',
      auditKbCreated: '创建知识库',
      auditKbDeleted: '删除知识库',
      auditDocUploaded: '上传文档',
      auditDocDeleted: '删除文档',
      systemSettings: '系统设置',
      ...
      nicknameOrPasswordRequired: '请输入昵称或密码！',
      ...
      deleteWhitelistEmailConfirmation:
        '确定要从白名单中删除该邮箱吗？此操作不可撤销。',

      importWhitelist: '导入白名单 (Excel)',
      importSelectExcelFile: 'Excel文件 (.xlsx)',
      importOverwriteExistingEmails: '覆盖已有邮箱',
      importInvalidExcelFile: '请选择有效的Excel文件',
      importFileRequired: '请选择要导入的文件',
      importFileTips: '文件必须包含名为 <code>email</code> 的单列表头。',
      ...
      deleteRole: '删除角色',
      deleteRoleConfirmation: '确定要删除该角色吗？此操作不可撤销。',
